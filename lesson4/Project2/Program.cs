...
namespace Project2
{
    class Program
    {
        ...
        {
            string Суть_задачи = @"  
            Написать программу, принимающую на вход строку — набор чисел, разделенных одним! пробелом, и
            ...
            {
                Сумма = Сумма + Convert.ToInt32(Часть); // возникнет исключение если вписывать числа по ошибке не через один пробем а через два и больше 
